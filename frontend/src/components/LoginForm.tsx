      ...
      <div className="mb-6 p-4 bg-blue-900/30 border border-blue-500/30 rounded-lg">
        ...
        <div className="space-y-2 text-xs">
          <div className="cursor-pointer hover:bg-blue-800/20 p-2 rounded transition-colors"
            ...
            <div className="text-blue-200">📧 mdoner.admin@gov.in</div>
            <div className="text-blue-200">🔑 MDoNER@2025</div>
          </div>
          <div className="border-t border-blue-500/20 pt-2 cursor-pointer hover:bg-blue-800/20 p-2 rounded transition-colors"
            ...
            <div className="text-blue-200">📧 client.user@project.in</div>
            <div className="text-blue-200">🔑 Client@2025</div>
          </div>
        </div>
      </div>
